...
.hyd{left:17%;top:13%}
.vizag{right:23%;top:22%}
.vij{left:45%;top:54%}
.raj{left:55%;top:57%}

.label-hyd{left:22%;top:18%}
.label-vizag{right:18%;top:28%}
.label-vij{left:38%;top:60%}
.label-raj{left:61%;top:63%}
  ...
  <div class="container-fluid px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="mainMenu">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <li><a href="#" class="nav-link">YARDS</a></li>
        <li><a href="#" class="nav-link">TRUSTED CLIENTS</a></li>
        <li><a href="#" class="nav-link active">CONTACT US</a></li>
        <li>
    ...
    <div class="info-layout">
      <div>
        <div class="info-card">
          ...
          <div>
            <h5>Head Office</h5>
            <p>12-15-3/1, Industrial Area,<br>Rajahmundry, Andhra Pradesh - 533101, India</p>
          </div>
        </div>
        ...
        <div class="info-card">
          ...
          <div>
            <h5>Phone</h5>
            <p>+91 91234 56789<br>+91 88300 12345</p>
          </div>
        </div>
        ...
        <div class="info-card">
          ...
          <div>
            <h5>Email</h5>
            <p>info@rajamundrysteels.com<br>sales@rajamundrysteels.com</p>
          </div>
        </div>
        ...
        <div class="info-card">
          ...
          <div>
            ...
            <p>Monday - Saturday<br>8:00 AM - 7:00 PM<br><span style="color:#c88d32;">Sunday Closed</span></p>
          </div>
        </div>
      </div>
